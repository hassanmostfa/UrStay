                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            @if ($booking->booking_status == 'in_negotiation')
                                <a href="{{ route('manage.owner.newBookings', ["owner" => $owner->id]) }}" style="background-color: #88394E !important;" class="btn btn-secondary mt-3">عودة إلى قائمة الطلبات</a>
                            @else
                                <a href="{{ route('manage.owner.bookings', ["owner" => $owner->id]) }}" style="background-color: #88394E !important;" class="btn btn-secondary mt-3">عودة إلى قائمة الطلبات</a>
                            @endif

                        @if ($booking->booking_status == 'in_negotiation')
                        <form action="{{ route('manage.owner.acceptBooking', ["owner" => $owner->id, 'id' => $booking->id]) }}" method="POST" class="mt-3">
                            @csrf
                            @method('PUT')
