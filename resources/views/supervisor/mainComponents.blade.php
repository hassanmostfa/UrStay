            ...
            <aside id="sidebar-left" class="sidebar-left">
                ...
                <div class="sidebar-header">
                    <div class="sidebar-title">
                        <p style="font-weight: bold;font-size: 18px">المالك:
                            {{ $owner->first_name . ' ' . $owner->last_name }}</p>
                    </div>
                                    ...
                                    <li class="nav-parent">
                                        ...
                                        <ul class="nav nav-children">
                                            <li class="d-flex align-items-center">
                                                <a class="nav-link"
                                                    href="{{ route('manage.owner.myUnits', ['owner' => $owner->id]) }}">
                                            ...
                                            <li class="d-flex align-items-center">
                                                <a class="nav-link"
                                                    href="{{ route('manage.owner.addUnit', ['owner' => $owner->id]) }}">
                                                    <i class="fa fa-angle-double-left" aria-hidden="true"></i>
                                                    اضافة وحده جديدة
                                                </a>
                                            </li>
                                            ...
                                            <li class="d-flex align-items-center">
                                                <a class="nav-link"
                                                    href="{{ route('manage.owner.updatedUnits', ['owner' => $owner->id]) }}">
                                                    <i class="fa fa-angle-double-left" aria-hidden="true"></i>
                                                    الوحدات المحدثة
                                                </a>
                                            </li>
                                            ...
                                            <li class="d-flex align-items-center">
                                                <a class="nav-link"
                                                    href="{{ route('manage.owner.rejectedUnits', ['owner' => $owner->id]) }}">
                                                    <i class="fa fa-angle-double-left" aria-hidden="true"></i>
                                                    الوحدات المرفوضة
                                                </a>
                                            </li>
                                ...
                                @if ($isAuthToBookingsManagment)
                                    <li class="nav-parent">
                                        ...
                                        <ul class="nav nav-children">
                                            <li class="d-flex align-items-center">
                                                <a class="nav-link"
                                                    href="{{ route('manage.owner.bookings', ['owner' => $owner->id]) }}">
                                                    <i class="fa fa-angle-double-left" aria-hidden="true"></i>
                                                    عمليات الحجز
                                                </a>
                                            </li>
                                            ...
                                            <li class="d-flex align-items-center">
                                                <a class="nav-link"
                                                    href="{{ route('manage.owner.newBookings', ['owner' => $owner->id]) }}">
                                                    <i class="fa fa-angle-double-left" aria-hidden="true"></i>
                                                    الطلبات الجديدة
                                                </a>
                                            </li>
                    ...
                    fetch(
                        ...
                        .then(data => {
                            ...
                            console.log('Full Address Data:',
                                address); // Log the full address data for debugging
                            ...
                            document.getElementById('state').value = address.state ||
                                ''; // State/Province
                            document.getElementById('city').value = address.city || address
                                .town || address.village || ''; // City or town
    ...
    <script>
        ...
        function toggleRoomSelection(card, item) {
            ...
            if (selectedRoomItems.includes(item)) {
                ...
                card.style.backgroundColor = '#88304e';
