    ...
    <div class="row">
        <div class="col-md-6">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('manage.owner.updateUnitAction', ['owner' => $owner->id, 'id' => $unit->id]) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div>
                                    ...
                                    <a href="{{ route('manage.owner.myUnits', ['owner' => $owner->id]) }}" style="background-color: #88394E !important;" class="btn btn-secondary">عودة إلى قائمة الوحدات</a>
