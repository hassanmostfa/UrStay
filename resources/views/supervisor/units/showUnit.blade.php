...
<div class="container mt-2 bg-white p-3">
    ...
    <div class="mt-3">
        ...
        <div id="div2" class="content-div">
            ...
            @else
            <form action="{{ route('manage.owner.completeUnit', ['owner' => $owner->id, 'id' => $unit->id]) }}" method="POST">
                            @csrf
                            <div class="row">
                ...
                <div class="col-md-12 offset-md-2">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <a href="{{ route('manage.owner.myUnits', ['owner' => $owner->id]) }}" style="background-color: #88394E !important;" class="btn btn-secondary mt-3">عودة إلى قائمة الوحدات</a>
