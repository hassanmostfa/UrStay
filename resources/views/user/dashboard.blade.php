...
<div class="container bg-white py-3">
	<h3 class="text-center text-danger">ملفك الشخصي غير مكتمل من فضلك قم باكمال ملفك الشخصي</h3>
    <h3 class="text-center mb-4">اختر الهوية</h3>

    <!-- Buttons for Choices -->
    <div class="d-flex justify-content-center mb-4">
        <button class="btn btn-primary mx-2" onclick="showForm('form1')">مواطن</button>
        <button class="btn btn-secondary mx-2" onclick="showForm('form2')">زائر</button>
        <button class="btn btn-success mx-2" onclick="showForm('form3')">مقيم</button>
    </div>

    <!-- Forms -->
    <div id="form1" class="form-container" style="display: none;">
        <h2>تسجيل بيانات مواطن</h2>
        <form method="POST" action="{{ route('citizenRegister') }}">
            @csrf
            <div class="mb-3">
                <label for="name1" class="form-label">رقم الهوية</label>
                <input type="text" class="form-control" id="name1" name="pid_number">
            </div>
            <div class="mb-3">
                <label for="date" class="form-label">تاريخ الميلاد</label>
                <input type="date" class="form-control" id="email1" name="birth_date">
            </div>
    ...
    <h4>تسجيل بيانات زائر</h4>
    <form method="POST" action="{{ route('visitorRegister') }}">
        @csrf
        <div class="mb-3">
            <label for="passport_number" class="form-label">رقم الجواز</label>
            <input type="text" class="form-control" id="passport_number" name="passport_number" placeholder="ادخل رقم الجواز">
        </div>
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="nationality" name="nationality" placeholder="ادخل الجنسية">
        </div>
    ...
    <div id="form3" class="form-container" style="display: none;">
        <h4>تسجيل بيانات مقيم</h4>
        <form method="POST" action="{{ route('residentRegister') }}">
            @csrf
            <div class="mb-3">
                <label for="phone3" class="form-label">رقم الاقامة</label>
                <input type="tel" class="form-control" id="phone3" name="resident_number">
            </div>
            <div class="mb-3">
                <label for="address3" class="form-label">تاريخ الميلاد</label>
                <input type="date" class="form-control" id="address3" name="birth_date">
            </div>
			...
			<div class="row">
				<div class="col-xl-8">
					<div class="chart-data-selector" id="salesSelectorWrapper">
						<h2>
							Sales By <h1>{{auth()->user()->first_name}}</h1>:
							<strong>
