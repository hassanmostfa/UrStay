...
@section('contents')
<button class="btn btn-primary m-3" style="background:#88394E !important;"><a style="color:white; text-decoration: none;" href="{{route('admin/user/create')}}">اضافة مستخدم جديد</a></button>
