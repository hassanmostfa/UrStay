...
@section('content')
<div class="container">
    <svg version="1.1" id="fi_24914" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="60.272px" height="60.272px" style="enable-background:new 0 0 60.272 60.272;width: 200px;height: 200px;margin: auto;display: block;" viewBox="0 0 60.272 60.272" style="enable-background:new 0 0 60.272 60.272;" xml:space="preserve">
        <g>
            <polygon points="31.577,1.863 44.039,10.002 44.039,58.579 31.577,58.579 	"></polygon>
		...
		l-4.663-1.356v-4.024l4.665,1.692v3.688H57.306z"></path>
    ...
    @if($unit->managed_by)
    <h1 style="font-family: MainFontBold;font-size: 42px;text-align: center;">
        هذه الوحدة تحت اشراف {{ $unit->admin->first_name . ' ' . $unit->admin->last_name }} لا يكمنك الاشراف عليها
    </h1>
    @else
    <h1 style="font-family: MainFontBold;font-size: 42px;text-align: center;">هذه الوحدة لم تستلم بعد!</h1>
    <a href="{{ route('addmin.assing.unit' , ['unitId' => $unit->id, 'adminId' => auth()->id()]) }}" style="margin: auto;display: block;width: max-content;" class="btn btn-success btn-lg">استلام</a>
    @endif
</div>
@endsection
