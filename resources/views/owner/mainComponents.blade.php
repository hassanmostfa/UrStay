					...
					<div id="userbox" class="userbox">
						<a href="#" data-bs-toggle="dropdown">
							...
							<div class="profile-info" data-lock-name="John Doe" data-lock-email="johndoe@okler.com">
								<span class="name">{{ Auth::guard('owner')->user()?->first_name . ' ' . Auth::guard('owner')->user()?->last_name }}</span>
				        ...
				        <div class="nano-content p-0 m-0" style="right:-8px!important;">
				            <nav id="menu" class="nav-main" role="navigation">
				                ...
				                <ul class="nav nav-main p-0">
				                    ...
				                    <li>
				                        <a class="nav-link" href="{{route('owner.assignPermissionsForm')}}">
                                            <i class='bx bx-user-pin'></i>
				                            <span>تعين مشرفين</span></span>
				                        </a>
				                    </li>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.getElementById('zone').addEventListener('change', function() {
        ...
        fetch(`https://urstay.tptc.com.sa/v9/owner/get-governorates/${zoneId}`)
    ...
    document.getElementById('governorate').addEventListener('change', function() {
        ...
        fetch(`https://urstay.tptc.com.sa/v9/owner/get-cities/${governorateId}`)
            .then(response => response.json())
            .then(data => {
    ...
    document.getElementById('city').addEventListener('change', function() {
        ...
        fetch(`https://urstay.tptc.com.sa/v9/owner/get-districts/${cityId}`)
            .then(response => response.json())
            .then(data => {
