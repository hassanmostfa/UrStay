        ...
        <div class="container login-container">
            <div class="card login-card">
                ...
                <div id="welcome-section"
                    ...
                    <h1 style="margin: 0;font-family: MainFontBold;font-size: 28px;">يسعدنا انضمامك معنا كمشرف.</h1>
                ...
                <div id="supervisor-section" style="display: none;" dir="rtl">
                    ...
                    <form enctype="multipart/form-data" action="{{ route('supervisorRegisterAction') }}"
                        method="POST" id="supervisor-form">
                        @csrf
                        <div class="input-row">
                ...
                <div id="success" class="add_your_unit has-outline" style="display: none;margin: 0 !important;flex-direction: column;justify-content: center;align-items: center;padding: 0 15px 50px;paddin-bottom: 72px !important">
                    <img src="{{ asset('/site/imgs/cangrad.Icon-13.png') }}" style="width: 330px;display: block; margin: auto" alt="">
                    <h1 style="font-family: MainFontBold;font-size: 48px;color: #fff;margin-top: 16px;">ﺗﻢ إنشاء حسابك ﺑﻨﺠﺎح!</h1>
                    <p>                        حسابك الان قيد المراجعة من قبل المسؤلين سوف نخبرك عندما يتم تفعيله                    </p>
                </div>
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        if (response.success === true) {
                            ...
                            $("#supervisor-form #phone").val($("#phone-form #phon_input").val())
                        } else {
                            alert(response.message);
                        }
                    },
