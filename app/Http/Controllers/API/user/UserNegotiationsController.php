...
class UserNegotiationsController extends Controller
{
...
public function getAllNegotiations() {
    ...
    /**********************************************************************************/
        // show all negotiations messages for current Booking
        ...
        public function update(Request $request , $booking_id) {
            ...
            try{
                ...
                $booking->user_price = $request->user_price;
                $booking->save();
                return response()->json(['status' => 'success', 'message' => 'تم تعديل السعر بنجاح بانتظار موافقة المالك'], 200);
            }catch(\Exception $e){
                return response()->json(['status' => 'error', 'message' => $e->getMessage()], 500);
            }
        }
        ...
        public function acceptNegotiation($booking_id) {
            try{
                $booking = Booking::findOrFail($booking_id);
                $booking->user_price = $booking->total_price;
