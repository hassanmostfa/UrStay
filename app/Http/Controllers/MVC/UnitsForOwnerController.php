...
class UnitsForOwnerController extends Controller
{
    ...
    public function addUnit(Request $request)
    {
        $validator = Validator::make($request->all(), [
            ...
            'rooms_images.*' => 'image|mimes:jpg,png,jpeg',
            'kitchen_images' => 'nullable|array',
            'kitchen_images.*' => 'image|mimes:jpg,png,jpeg',
            'has_mot_permission' => 'required|boolean',
            'mot_permission' => 'nullable|file|mimes:pdf,jpg,jpeg,png',
        ], [
            'title.required' => 'العنوان مطلوب.',
            'title.string' => 'العنوان يجب أن يكون نصًا.',
            'title.max' => 'العنوان يجب ألا يتجاوز 255 حرفًا.',
            'category.required' => 'الفئة مطلوبة.',
            'zone_name.required' => 'اسم المنطقة مطلوب.',
            'zone_name.string' => 'اسم المنطقة يجب أن يكون نصًا.',
            'zone_name.max' => 'اسم المنطقة يجب ألا يتجاوز 255 حرفًا.',
            'governorate_name.required' => 'اسم المحافظة مطلوب.',
            'governorate_name.string' => 'اسم المحافظة يجب أن يكون نصًا.',
            'governorate_name.max' => 'اسم المحافظة يجب ألا يتجاوز 255 حرفًا.',
            'city_name.required' => 'اسم المدينة مطلوب.',
            'city_name.string' => 'اسم المدينة يجب أن يكون نصًا.',
            'city_name.max' => 'اسم المدينة يجب ألا يتجاوز 255 حرفًا.',
            'district_name.required' => 'اسم المنطقة مطلوب.',
            'district_name.string' => 'اسم المنطقة يجب أن يكون نصًا.',
            'district_name.max' => 'اسم المنطقة يجب ألا يتجاوز 255 حرفًا.',
            'location.required' => 'الموقع مطلوب.',
            'location.string' => 'الموقع يجب أن يكون نصًا.',
            'location.max' => 'الموقع يجب ألا يتجاوز 255 حرفًا.',
            'size.required' => 'الحجم مطلوب.',
            'size.numeric' => 'الحجم يجب أن يكون رقمًا.',
            'rooms.required' => 'عدد الغرف مطلوب.',
            'rooms.integer' => 'عدد الغرف يجب أن يكون عددًا صحيحًا.',
            'no_of_single_beds.required' => 'عدد الأسرة المفردة مطلوب.',
            'no_of_single_beds.integer' => 'عدد الأسرة المفردة يجب أن يكون عددًا صحيحًا.',
            'no_of_master_beds.required' => 'عدد الأسرة الرئيسية مطلوب.',
            'no_of_master_beds.integer' => 'عدد الأسرة الرئيسية يجب أن يكون عددًا صحيحًا.',
            'pool.required' => 'عدد المسابح مطلوب.',
            'pool.integer' => 'عدد المسابح يجب أن يكون عددًا صحيحًا.',
            'table_chairs.required' => 'عدد الطاولات والكراسي مطلوب.',
            'table_chairs.integer' => 'عدد الطاولات والكراسي يجب أن يكون عددًا صحيحًا.',
            'bathrooms.required' => 'عدد الحمامات مطلوب.',
            'bathrooms.integer' => 'عدد الحمامات يجب أن يكون عددًا صحيحًا.',
            'images.*.image' => 'الصورة يجب أن تكون صورة.',
            'images.*.mimes' => 'الصورة يجب أن تكون من نوع jpg أو png أو jpeg.',
            'images.*.max' => 'حجم الصورة يجب ألا يتجاوز 2048 كيلوبايت.',
            'rooms_images.*.image' => 'صورة الغرفة يجب أن تكون صورة.',
            'rooms_images.*.mimes' => 'صورة الغرفة يجب أن تكون من نوع jpg أو png أو jpeg.',
            'rooms_images.*.max' => 'حجم صورة الغرفة يجب ألا يتجاوز 2048 كيلوبايت.',
            'kitchen_images.*.image' => 'صورة المطبخ يجب أن تكون صورة.',
            'kitchen_images.*.mimes' => 'صورة المطبخ يجب أن تكون من نوع jpg أو png أو jpeg.',
            'kitchen_images.*.max' => 'حجم صورة المطبخ يجب ألا يتجاوز 2048 كيلوبايت.',
            'has_mot_permission.required' => 'إذن MOT مطلوب.',
            'has_mot_permission.boolean' => 'إذن MOT يجب أن يكون قيمة منطقية.',
            'mot_permission.mimes' => 'إذن MOT يجب أن يكون من نوع pdf أو jpg أو jpeg أو png.',
            'mot_permission.max' => 'حجم إذن MOT يجب ألا يتجاوز 2048 كيلوبايت.',
        ]);
        ...
        if ($validator->fails()) {
            ...
            return redirect()->back()
                ...
                ->with('toast', true); // Pass a flag to indicate errors
        ...
        if ($request->hasFile('additional_images')) {
            ...
            $unit->save();
            $msg = "تم اضافة وحدة جديدة " . $unit->title . " بواسطة: " . Auth::user()->first_name . ' ' . Auth::user()->last_name;
            $channel = "Admin"; // You can define the channel name
            $channel_type = "channel"; // Type of channel or context for clarity
            $href = route('admin.unitDetails', $unit->id); // Link to view the unit details
            ...
            return redirect()->route('unit.success');
        } catch (\Exception $e) {
    ...
    {
        $query = Unit::where('owner_id', Auth::id());
...
public function updateUnit(Request $request, $id)
{
    ...
    public function showAddNow() {
        return view('owner.addUnitNow');
    }
}
